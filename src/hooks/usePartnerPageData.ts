...
import { fetchPartnerPageData } from '../services/korionChongApi'

type Query = Record<string, string | number | undefined>

export function usePartnerPageData<T>(path: string, initialData: T, query?: Query) {
